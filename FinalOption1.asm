...
######################################
#                                    #
# fn_encrypt - Encrypt a string      #
###################################  #
# Arguments                       #  #
# $a0 the string to be encrypted  #  #
# $a1 the integer key             #  #
#                                 #  #
# Returns                         #  #
# $a0 the encrypted string        #  #
###################################  #
#                                    #
# fn_decrypt - Decrypt a string      #
###################################  #
# Arguments                       #  #
# $a0 the encrypted string        #  #
# $a1 the integer key             #  #
...
op1:	la $a0,p4		# display "Please enter a message to be encrypted: " 
	...
	la $a0,p8		# display "The text was successfully encrypted: "
...
encrypt:
	# For through the string and add key to each char
...
p6:	.asciiz "Please enter the integer key: "
p7:	.asciiz "Please enter a message: "
p8:	.asciiz "The text was successfully encrypted: "
p9:     .asciiz "The text was successfully decrypted: "
space:	.asciiz " "
endl:   .asciiz "\n"
